...
def predict_age_and_gender_video(input_path: str, output_path: str, show_result: bool = False):
...
if __name__ == "__main__":
    input_video_path = 'video/face_detection.mp4'
    output_video_path = 'output_video.mp4'
    predict_age_and_gender_video(input_video_path, output_video_path, show_result=True)
